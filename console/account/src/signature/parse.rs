...
mod tests {
    ...
    fn test_parse() -> Result<()> {
        ...
        assert!(Signature::parse(&format!("{SIGNATURE_PREFIX}1")).is_err());
        ...
        for i in 0..ITERATIONS {
            ...
            let (remainder, candidate) = Signature::parse(&expected).unwrap();
    ...
    fn test_display() -> Result<()> {
        ...
        for i in 0..ITERATIONS {
            ...
            let candidate_recovered = Signature::from_str(&candidate.to_string())?;
