    ...
    fn output_mode(case: &Self::Case) -> Mode {
        match (case.0.mode(), case.1.mode()) {
            ...
            (_, Mode::Constant) => match &case.1 {
                ...
                _ => Circuit::halt("The constant is required to determine the output mode of Public NOR Constant"),
            },
            (Mode::Constant, _) => match &case.0 {
                ...
                _ => Circuit::halt("The constant is required to determine the output mode of Constant NOR Public"),
            },
            (_, _) => Mode::Private,
        }
    }
