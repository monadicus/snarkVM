...
impl Visibility for Plaintext {
    ...
    fn size_in_fields(&self) -> u16 {
        ...
        let num_fields = (num_bits + ConsoleField::size_in_data_bits() - 1) / ConsoleField::size_in_data_bits();
        // Ensure the number of field elements does not exceed the maximum allowed size.
        match num_fields <= AleoV0::MAX_DATA_SIZE_IN_FIELDS as usize {
            // Return the number of field elements.
            true => num_fields as u16,
            false => Circuit::halt("Plaintext is too large to encode in field elements."),
        }
    }
}
